...
/**
 * High Frequency Trader based on bid and ask prices
 ...
 * if the buy book is filled, the new books will be buy book at 0.49 and sell book at 0.50. the size of the books will be determined by `coefficient`, using formula `size = (Math.abs(orderPx - basePx)/gap*coeffient + 1) * baseSz`;
 */
