...
import { SwapTraderFormItems } from './swap-trader-form';

import styles from './swap-trader-detail.module.scss';
...
export const SwapTraderDetail = ({ trader }: { trader: OkxTraderItem }) => {
