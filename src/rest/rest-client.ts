...
import { getRestBaseUrl } from './util/request-util';
import { BaseRestClient } from './util/rest-client-base';

export class OkxRestClient extends BaseRestClient {
  /**
  ...
  getOrderList(params?: PendingOrderRequest): Promise<OrderListItem[]> {
  ...
  setAutoLoan(params: { autoLoan: boolean }): Promise<{ autoLoan: boolean }> {
