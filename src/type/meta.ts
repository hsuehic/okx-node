...
export type InstrumentTypeWithAny = InstrumentType | 'ANY';
...
export interface DerivativeInstrument extends Instrument {
...
export type TradeMode = 'isolated' | 'cross' | 'cash';
export type PosSide = 'net' | 'short' | 'long';
export type OrdType =
  | 'market'
  | 'limit'
  | 'post_only'
...
export type QuickMgnType = 'manual' | 'auto_borrow' | 'auto_repay';
export type StpMode = 'cancel_maker' | 'cancel_taker' | 'cancel_both';
export type SizeUnit = 'quote_ccy' | 'base_ccy';
