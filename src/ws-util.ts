import { WsChannel } from './type/meta.js';

export type WS_KEY = 'private' | 'public' | 'business';
...
export type MARKET = keyof typeof WS_BASE_URL;

export const getWsUrl = (market: MARKET, key: WS_KEY): string => {
 ...
 * @returns {WS_KEY}
 */
export const getWsKeyForTopicChannel = (channel: WsChannel): WS_KEY => {
